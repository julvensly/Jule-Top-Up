import { useNavigate } from "react-router-dom";
 ...
 { name: "310 💎", price:  "400 HTG" },
 { name: "572 💎", price: "740 HTG" },
 { name: "2000   💎", price: "2580 HTG" },
 { name: "4960 💎", price: "6400 HTG" }, 
    { name: "Weekly Membership (1 semèn)", price: "250 HTG" },
 { name:  "Monthly Membership (1 mwa)", price: "900 HTG" },
 ...
 <div key={index}>
 <img  className="deux-colonnes" src="/Freefire2.jpg" alt="Free  Fire"
            />
 <h3>{plan.name}</h3>
 <p>Pri: {plan.price}</p>
 <button  onClick={() =>
